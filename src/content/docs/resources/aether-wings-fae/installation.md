---
title: Installation
description: Requirements and setup steps for aether_wings_fae.
---
...
1. Copy `aether_wings_fae` into your `resources` folder.
2. Add `ensure aether_wings_fae` to `server.cfg`.
...
The props appear. `faewingsmenu` opens the menu.
