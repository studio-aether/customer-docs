---
title: Configuration
description: Every option in config.lua for aether_wings_demon.
---
...
```lua
Config.Permissions = {
    use   = { ace = 'aether_wings_demon.use',   groups = { 'user', 'admin' }, everyone = true },
    tint  = { ace = 'aether_wings_demon.tint',  groups = { 'user', 'admin' }, everyone = true },
    save  = { ace = 'aether_wings_demon.save',  groups = { 'user', 'admin' }, everyone = true },
    gizmo = { ace = 'aether_wings_demon.gizmo', groups = { 'admin' },         everyone = true },
    admin = { ace = 'aether_wings_demon.admin', groups = { 'admin' },         everyone = false },
}
```
...
```
add_ace group.admin aether_wings_demon.admin allow
```
...
The wings beat slowly and wide, the way a heavy membrane wing would. `Config.WingMotion` sets the character.
